...
bool init()
{
	...
	if (SDL_Init(SDL_INIT_EVERYTHING) < 0)
	{
		...
		window = SDL_CreateWindow("Light Development Project", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, settings[0], settings[1], SDL_WINDOW_HIDDEN /*| SDL_WINDOW_OPENGL*/);
		if(window == NULL)
		{
